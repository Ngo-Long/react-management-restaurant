		...
		<>
			<Layout style={{ backgroundColor: backgroundColor }}>
					...
					<section className="hero__body">
						<div className="hero-wrap__img">
							<figure className="hero__image">
								<img
									src="./assets/icon/meomeo.png"
									alt=""
									className="hero__img"
								/>
								<img
									src="./assets/icon/icon-right.svg"
									alt=""
									className="hero__decor hero__decor--right"
								/>
								<img
									src="./assets/icon/icon-left.svg"
									alt=""
						...
						<section className="hero-block__text">
							<h1 className="hero__heading">Quản lý nhà hàng miễn phí</h1>

							<p className="hero__desc">
								Quản lý nhà hàng miễn phí với nhiều tính năng tiện lợi, hỗ trợ
								tối ưu hóa mọi hoạt động kinh doanh các nhà hàng nhỏ đến lớn.
							</p>

							<div
								className="hero__block__btn"
				...
				<section style={{ padding: "20px", textAlign: "center" }}>
					<Typography.Title level={3} style={{ color: textColor }}>
						Quản lý nhà hàng hiệu quả
					</Typography.Title>
					<Typography.Text style={{ fontSize: "16px", color: secondaryColor }}>
						<ArrowUpOutlined /> Cô hội nhà kinh doanh quản lý nhà hàng
					</Typography.Text>
				</section>

				<section
					style={{ ...sectionStyle, maxWidth: "1000px", margin: "40px auto" }}
				>
						...
						<Row gutter={[24, 24]} align="middle" justify="start">
							...
							<Col xs={24} md={12}>
								<Typography.Title level={4} style={{ color: textColor }}>
									Quản lý quy trình Phục vụ - Thu ngân - Bếp chuẩn xác, thuận
									lợi
								</Typography.Title>
								...
								>
									Theo dõi hoạt động, thao tác thông báo giữa các bên phục vụ,
									thu ngân, quầy bar/bếp thuận tiện và kịp thời.
						...
						<Row gutter={[24, 24]} align="middle" justify="start">
							...
							<Col xs={24} md={12}>
								...
								<Typography.Paragraph
									style={{ color: textColor, lineHeight: "1.6" }}
								>
									Phục vụ khách với món thông qua Mobile, Tablet chuyên nghiệp,
									dễ dàng thêm/bớt topping,... đáp ứng mọi nhu cầu cao điểm.
									<ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
						...
						<Row gutter={[24, 24]} align="middle" justify="start">
							...
							<Col xs={24} md={12}>
								...
								<Typography.Paragraph
									style={{ color: textColor, lineHeight: "1.6" }}
								>
									Hỗ trợ thu ngân thanh toán nhanh trong giờ cao điểm, giảm
									thiểu nhầm lẫn. Tất cả thao tác của nhân viên đều được lưu trữ
									rõ ràng, dễ dàng tra cứu khi cần thiết.
								</Typography.Paragraph>
						...
						<Row gutter={[24, 24]} align="middle" justify="start">
							...
							<Col xs={24} md={12} style={{ order: 1 }}>
								...
								<Typography.Paragraph
									style={{ color: textColor, lineHeight: "1.6" }}
								>
									Tích hợp máy in bếp thông báo gọi món. Màn hình bếp hiển thị
									trực tiếp tất cả món ăn được yêu cầu chế biến từ bồi bàn hoặc
									khách hàng.
								</Typography.Paragraph>
						...
						<Row gutter={[24, 24]} align="middle" justify="start">
							...
							<Col xs={24} md={12}>
								...
								<Typography.Paragraph
									style={{ color: textColor, lineHeight: "1.6" }}
								>
									Phần mềm hỗ trợ quản lý phòng bàn chuyên nghiệp, kiểm tra
									nhanh bàn nào còn trống, bàn nào đã có khách... hoặc đặt bàn
									sẵn theo nhu cầu của khách.
								</Typography.Paragraph>
				...
				>
					<Row gutter={[16, 16]} justify="space-around">
						<Col xs={24} sm={12} md={8} lg={6}>
							<Typography.Title level={5} style={{ color: lightTextColor }}>
								Rservice
							</Typography.Title>
							...
							<Typography.Paragraph style={{ color: lightTextColor }}>
								...
								12, TP. HCM.778/B1 Nguyễn Kiệm, phường 04, quận Phú Nhuận, TP
								HCM SĐT: 0901 660 002 – 028 6686 6486
							</Typography.Paragraph>
						</Col>
