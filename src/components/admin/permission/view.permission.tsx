            ...
            >
                <Descriptions title="" bordered column={2} layout="vertical">
                    ...
                    <Descriptions.Item label="Ngày tạo">
                        {dataInit && dataInit.createdDate ? dayjs(dataInit.createdDate).format('DD-MM-YYYY HH:mm:ss') : ""}
                    </Descriptions.Item>

                    <Descriptions.Item label="Ngày sửa">
                        {dataInit && dataInit.lastModifiedDate ? dayjs(dataInit.lastModifiedDate).format('DD-MM-YYYY HH:mm:ss') : ""}
                    </Descriptions.Item>
